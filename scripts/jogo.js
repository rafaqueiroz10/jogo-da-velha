...
let contJogadas = 0;
vez = primeiroAComecar;
let vitoriasBolinha = 5, vitoriasX = 1;
let temVencedor;
...
function jogo(e) {
    ...
    reproduzir("click-na-celula.mp3");
    contJogadas++;
    ...
    if (temVencedor || empate()) {
        if (temVencedor) {
            ...
            if (vitoriasX === 1 || vitoriasBolinha === 1) {
                if (vitoriasX === 7 || vitoriasBolinha === 7) {
                    reproduzir("gol-da-alemanha.mp3");
                }
                else if (vitoriasX === 6 || vitoriasBolinha === 1) {
                    reproduzir("gol-do-barcelona.mp3");
                }
            }
            /* else if (temVencedor) {
            }
